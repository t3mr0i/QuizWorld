...
export function submitAnswers() {
    ...
    } else if (!gameState.clientSideMode) {
...
export function processLocalResults() {
    ...
    // import { displayRoundResults } from './ui.js'; // Need to ensure this is imported
    if (typeof displayRoundResults === 'function') {
        displayRoundResults(resultsData);
        showScreen('results'); // Ensure results screen is shown
    } else {
        console.error("displayRoundResults function not available for local results!");
        showError("Could not display locally processed results.");
    }
} 